...
import { get__invitations, post__invitations, patch__invitations, delete__invitations, get__invitations__by__requester, get__invitations__by__offerer, get__invitations__of__posts__request,verify__invitation} from '../Controllers/crud__invitations.js';
...
invitations__router.get('/exist/:id/:post', verify__invitation);
