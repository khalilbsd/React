			...
			<div style={{
				...
				{this.state.askForUsername === true ?
					<div style={{
						...
						<Button variant="contained" color="primary" onClick={this.connect} style={{ margin: "20px" }}>Join Meeting</Button>
					</div>
					:
					<div>

						<div className="btn-down" style={{ backgroundColor: "#424242", color: "whitesmoke", textAlign: "center" }}>
							...
							{this.state.screenAvailable === true ?
								<IconButton style={{ color: "#fff" }} onClick={this.handleScreen}>
						...
						<div className="container">
							<Row id="main" className="flex-container" style={{ margin: 0, padding: 0 }}>
								<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
									borderStyle: "solid", borderColor: "#424242", margin: "10px", objectFit: "fill",
									width: "30%", height: "70%"
								}} />
							</Row>
						</div>
